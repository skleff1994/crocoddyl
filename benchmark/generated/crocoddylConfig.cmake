...
set("CROCODDYL_DOXYGENDOCDIR" "${PACKAGE_PREFIX_DIR}/share/doc/crocoddyl/doxygen-html")
set("crocoddyl_DEPENDENCIES" "pinocchio;example-robot-data;Boost;eigenpy")
set("crocoddyl_PKG_CONFIG_DEPENDENCIES" "eigen3 >= 3.0.5")
...
set(_PKG_CONFIG_LIBS_LIST " -lcrocoddyl -L/usr/lib/x86_64-linux-gnu")
...
if(${CMAKE_VERSION} VERSION_LESS "3.15.0")
  ...
  find_package(pinocchio 2.4.7 REQUIRED)
  find_package(example-robot-data 3.2.0 REQUIRED)
  find_package(Boost REQUIRED COMPONENTS filesystem serialization system)
  find_package(eigenpy 2.2.0 REQUIRED)
else()
  SET(Boost_USE_STATIC_LIBS OFF)
  SET(Boost_USE_MULTITHREADED ON)
  SET(Boost_NO_BOOST_CMAKE ON)
  find_dependency(pinocchio 2.4.7 REQUIRED)
  find_dependency(example-robot-data 3.2.0 REQUIRED)
  find_dependency(Boost REQUIRED COMPONENTS filesystem serialization system)
  find_dependency(eigenpy 2.2.0 REQUIRED)
endif()
...
ADD_DEFINITIONS(-DCROCODDYL_WITH_MULTITHREADING -DCROCODDYL_WITH_NTHREADS=16)
